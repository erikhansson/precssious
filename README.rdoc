...
/lib/tasks/precssious.rake
  ...
  task :precssious => :environment do
    require 'precssious'
...
Precssious.directory defaults to public/stylesheets in the application directory,
but can be set to any directory holding "precssious directories".
